...
export default function Home() {
  ...
  return (
    <div className="w-full min-h-screen p-8 transition-colors duration-300 bg-light-bg dark:bg-dark-bg text-light-text dark:text-dark-text flex flex-col items-center justify-center font-sans gap-8">
